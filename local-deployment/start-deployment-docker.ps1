...
Write-Host ""
Write-Host "[START] AIZESK Local Development Environment" -ForegroundColor Cyan
...
if (-not (Test-Path ".env")) {
    Write-Host "[i] Creating .env file with default values..." -ForegroundColor Yellow
    @"
...
switch ($Mode.ToLower()) {
    "infra" {
        ...
        Write-Host "=====================================================" -ForegroundColor Cyan
        Write-Host ""
        Write-Host "  [DB] Database (MySQL)"
        Write-Host "     -> localhost:3307"
        Write-Host "     -> User: aizesk / Password: aizesk-mysql-2024"
        Write-Host ""
        Write-Host "  [MAIL] Email Testing (MailHog)"
        Write-Host "     -> http://localhost:8025"
        Write-Host ""
        Write-Host "=====================================================" -ForegroundColor Cyan
        Write-Host ""
        Write-Host "[i] Now run your microservices locally:" -ForegroundColor Yellow
        Write-Host "   cd ..\notification-service"
        Write-Host "   mvn spring-boot:run"
        Write-Host ""
        Write-Host "[i] Useful Commands:" -ForegroundColor Yellow
    ...
    default {
        ...
        Write-Host ""
        Write-Host "[OK] Environment Started!" -ForegroundColor Green
        Write-Host ""
        Write-Host "=====================================================" -ForegroundColor Cyan
        ...
        Write-Host "     -> http://localhost:8025"
        Write-Host ""
        Write-Host "  [NOTIFY] Notification Service"
